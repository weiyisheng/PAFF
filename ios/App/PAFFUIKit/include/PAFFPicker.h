...
#define PAFFPickerTopBarTitleColor PA_COLOR_FOR_KEY(@"#333333")
...
#define PAFFPickerTopBarLeftButtonTitleColor PA_COLOR_FOR_KEY(@"#666666")
#define PAFFPickerTopBarRightButtonTitle @"保存"
#define PAFFPickerTopBarRightButtonTitleColor  PA_COLOR_FOR_KEY(@"#333333")

#define PAFFPickerBackgroundColor PA_COLOR_FOR_KEY(@"#f8f8f8")
...
#define PAFFPickerRowNormalTextColor PA_COLOR_FOR_KEY(@"#bbbbbb")
#define PAFFPickerRowSelectedBackgroundColor [UIColor whiteColor]
#define PAFFPickerRowSelectedTextColor PA_COLOR_FOR_KEY(@"#3399ff")

#define PAFFPickerSelectionLineColor PA_COLOR_FOR_KEY(@"#d9d9d9")
