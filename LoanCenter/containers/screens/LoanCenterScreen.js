...
import * as LoanCenterActions from '../../actions/LoanCenterAction'
...
class Loan extends Component{
  ...
  componentDidMount() {
    this.props.action.queryCustInfo()
    this.props.action.isCustInfoComplete()
    this.props.action.isCreditDone()
  }
  ...
  render() {
    console.log('custInfo', this.props.custInfo);
    console.log('isCustInfoComplete', this.props.isCustInfoComplete);
    console.log('isCustCreditDone', this.props.isCustCreditDone);
    return (
      <View>
...
function mapStateToProps(state) {
  return {
    custInfo: state.Loan.LoanCenter.custInfo,  //客户信息
    isCustInfoComplete: state.Loan.LoanCenter.isCustInfoComplete,  //客户信息是否完整
    isCustCreditDone: state.Loan.LoanCenter.isCustCreditDone  //是否授信1W
  }
}
...
function mapDispatchToProps(dispatch) {
  return {
    action: bindActionCreators(LoanCenterActions, dispatch)
  }
}

module.exports = connect(mapStateToProps, mapDispatchToProps)(Loan);
